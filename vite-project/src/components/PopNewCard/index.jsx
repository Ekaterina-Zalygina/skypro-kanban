                ...
                <S.NewCardBlock>
                    <S.NewCardContent>
                        ...
                        <S.NewCardWrap>
                            <S.NewCardForm id="formNewCard" action="#" onSubmit={createTask}>
                                <S.FormNewBlock>
                                    <S.NewCardSubttl htmlFor="formTitle">Название задачи</S.NewCardSubttl>
                                    <S.FormNewInput
                                        onChange={(e) => setAddValue({ ...addValue, title: e.target.value })}
                                        type="text"
                                        name="title"
                                        id="formTitle"
                                ...
                                <S.FormNewBlock>
                                    <S.NewCardSubttl htmlFor="textArea">Описание задачи</S.NewCardSubttl>
                                    <S.FormNewArea
                                        onChange={(e) => setAddValue({ ...addValue, text: e.target.value })}
                                        name="text"
                                        id="textArea"
